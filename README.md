...
```Groovy
compile 'com.google.cloud:google-cloud-os-login:0.117.2-alpha'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-os-login" % "0.117.2-alpha"
```
...
[os-login-client-lib-docs]: https://googleapis.dev/java/google-cloud-clients/latest/index.html?com/google/cloud/oslogin/v1/package-summary.html
